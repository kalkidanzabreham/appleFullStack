			...
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <div className="navbar-collapse collapse">
			        <ul className="navbar-nav nav-justified w-100 nav-fill">
						...
						<li className="nav-item"><Link className="nav-link js-scroll-trigger" to="#">watch</Link></li>
						<li className="nav-item"><Link className="nav-link js-scroll-trigger" to="#">tv</Link></li>
						<li className="nav-item"><Link className="nav-link js-scroll-trigger" to="#">Music</Link></li>
						<li className="nav-item"><Link className="nav-link js-scroll-trigger" to="#">Support</Link></li>
